<div class="flex sticky top-0 z-30 shadow-sm items-center justify-between bg-white w-full h-16 px-1 vs:px-5 py-1">
    ...
    <div class="flex items-center justify-end w-fin">
        <a href="{{url('/liked')}}" class="px-0.5 sss:px-2 cursor-pointer">
        ...
        <a href="{{url('/carts')}}" class="relative cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 sss:size-6 hover:fill-black">
            ...
            <div class="absolute -top-2 sss:-top-2.5 left-2.5 sss:left-3 bg-primary-1 rounded-lg w-3 h-3.5 sss:w-4 sss:h-5 text-center">
                <p class="-translate-y-0.5 sss:-translate-y-0 sss:text-sm text-small font-semibold text-white">{{$totalcart}}</p>
            </div>
