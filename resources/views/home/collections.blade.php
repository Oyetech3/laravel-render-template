<div class="my-14 w-full px-10 py-10 rounded-lg ">
    ...
    <div class="grid lg:grid-cols-2 gap-10 w-full justify-center items-center place-items-center py-10">
        ...
        <div class="flex gap-5">
            <a href="">
                <div class="coll">
                    <img class="w-full h-full rounded-lg"
                         src="{{ $item->imageone_url }}"
                         alt="{{ $item->collection_name }}">
                    <div class="absolute top-2/4 mt-10 py-6 px-6">
                        <p class="font-bold text-black text-xl leading-relaxed" style="-webkit-text-stroke: 1px white;">
            ...
            <div class="colldiv">
                <div class="collone">
                    <img src="{{ $item->imagetwo_url }}"
                         class="h-full w-full rounded-lg">
                </div>
                <div class="colltwo">
                    <img src="{{ $item->imagethree_url }}"
                         class="h-full w-full rounded-lg">
                </div>
            </div>
        </div>
